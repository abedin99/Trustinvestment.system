<x-app-layout>
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ url(Route::getFacadeRoot()->current()->uri()) }}" method="GET" class="card">
                                    ...
                                    <div class="form-group col-md-3 col-sm-3 col-12">
                                        ...
                                        <select name="user" class="form-control select2" id="user">
                                            ...
                                            @foreach ($users as $key => $user)
                                                <option value="{{ $user->username }}" @selected(request('user')==$user->username)>{{$user->username }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                @endisset
                                ...
                                <div class="card text-left">
                                    ...
                                    <div class="card-body">
                                                        ...
                                                        <div class="bg-success p-3">
                                                            ...
                                                            @foreach ($log->changes['attributes'] as $key => $attribute)
                                                                <p class="ml-4 m-0">[{{ $key }}] =>
                                                                    {{ ($attribute) ? var_dump($attribute)  : null }}</p>
                                                            @endforeach
                                                            <p class="m-0">)</p>
                                                        </div>
                                                    </div>
                                        ...
                                        @if ($log->subject_id)
                                            ...
                                            @endphp
                                            @if ($subject && $subject->post && $subject->post->title)
                                        ...
                                        @endif
                                        <p>Author:
                                            <b class="text-danger">{{ $log->causer->name }}</b></p>
                                    </div>
                                </div>
                            @endforeach
                        </div>
