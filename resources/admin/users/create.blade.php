                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="disabled_at" id="disabled_at"
                                            @if (old('disabled_at')) checked @endif data-bootstrap-switch
                                        ...
                                        <div class="card-body">
                                            ...
                                            @if ($errors->has('departments'))
                                                <div class="alert alert-danger">
                                                    <div class="text-bold">{{ $errors->first('departments') }}</div>
                                                </div>
                                            @endif
                                                ...
                                                <div class="form-check">
                                                    <label class="form-check-label">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            @checked(old('departments') && in_array($department->slug, old('departments')))>{{ $department->name }}
                                                    </label>
                                                </div>
                                                            ...
                                                            <div class="form-check">
                                                                <label class="form-check-label">
                                                                    <input type="checkbox" class="form-check-input"
                                                                        name="departments[]"
                                                                        value="{{ $item->slug }}"
                                                                        @checked(old('departments') && in_array($item->slug, old('departments')))>{{ $item->name }}
                                                                </label>
                                                            </div>
                                                        @endforeach
                                                    </div>
