        ...
        <ul class="nav-left">
            ...
            <li class="search-box">
                <a class="search-toggle no-pdd-right" href="javascript:void(0);">
                    <i class="search-icon fa-solid fa-search pdd-right-10"></i>
                    <i class="search-icon-close fa-solid fa-times pdd-right-10"></i>
                </a>
            </li>
        ...
        <ul class="nav-right">
            <li class="notifications dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="pX-20 pY-15 ta-c bdT"><span><a href="" class="c-grey-600 cH-blue fsz-sm td-n">View
            ...
            <li class="notifications dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="pX-20 pY-15 ta-c bdT"><span><a href="/email"
            ...
            <li class="dropdown">
                <a href="" class="dropdown-toggle no-after peers fxw-nw ai-c lh-1" data-toggle="dropdown">
                    <div class="peer mR-10"><img class="w-2r bdrs-50p" src="{{ asset('assets/img/avatar.png') }}"
                            alt=""></div>
                    <div class="peer"><span
                            class="fsz-sm c-grey-900">{{ Auth::guard('admin')->user()->username }}</span></div>
                </a>
                <ul class="dropdown-menu fsz-sm">
                    ...
                    <li>
                        <a href="{{ route('admin.profile.edit') }}" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700">
